...
namespace dubins
{
    ...
    public:
        ...
        double *getAnglesShortestPath(DubinsPoint **points, int numberOfPoints, std::vector<Polygon> obstacles, Polygon map);
        ...
        Curve **multipointShortestPath(DubinsPoint **points, int numberOfPoints, std::vector<Polygon> obstacles, Polygon map);
    };
