...
namespace convex {
    // Anonymous namespace, code taken from: https://www.geeksforgeeks.org/convex-hull-using-graham-scan/
    namespace {
    ...
    std::vector<evacuation::Polygon> getConvexHull(std::vector<evacuation::Polygon> polys) {
        std::vector<evacuation::Polygon> ret;
        for (evacuation::Polygon poly: polys) {
            ret.emplace_back(convexHull(poly.points));
        }
        return ret;
